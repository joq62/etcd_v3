...
init_mnesia(Nodes)->
    ...
    CreateSchema=rpc:multicall(InitialNode,mnesia,create_schema,[Nodes]),
    io:format("DBG CreateSchema ~p~n",[{CreateSchema,?MODULE,?FUNCTION_NAME,?LINE}]),
    
    MultiMnesiaStart_1=rpc:multicall(Nodes,mnesia,start_1,[]),
